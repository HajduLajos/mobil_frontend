      ...
      <View style={{ flex: 1, padding: 24, }}>
        ...
        {isLoading ? (
          ...
          <FlatList
            ...
            <TouchableOpacity style={{ textAlign:'center', backgroundColor: "#06c995", width: 175, height: 45, padding: 8,marginLeft:65 }} onPress={() => navigation.navigate('KiiratXbox', {nev:item.alkatresz_info, kep:item.alkatresz_kep, ar:item.alkatresz_ar, ev:item.alkatresz_garancia })}>
