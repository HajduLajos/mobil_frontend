      ...
      <View style={{ flex: 1, padding: 24,  alignItems: 'center' }}>
        ...
        {isLoading ? (
          ...
          <FlatList
            ...
            <TouchableOpacity style={{ textAlign:'center', backgroundColor: "#06c995", width: 175, height: 45, padding: 8,marginLeft:45 }} onPress={() => navigation.navigate('KiiratPcJatekok', {nev:item.jatekok_nev, kep:item.jatekok_kep, ar:item.jatekok_ar, ev:item.jatekok_megjelenes })}>
